...
export const Footer = () => {
  ...
  const navigationSocial = [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/stgrapho78",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/sandrine-thibierge-75112a27/",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
    ...
    <footer>
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; {new Date().getFullYear()} La Graphothérapie - Tous droits
          réservés.
        </p>
      </div>
    </footer>
